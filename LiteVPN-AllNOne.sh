...
read -p "Password baru: " -e -i litevpn123 DatabasePass
echo ""
...
organizationalunit=CyberSecurity
commonname=www.litevpn.dev
...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/Klemenxer/LiteVPN/master/addons/sources.list.debian8"
